...
<div class="container">
    ...
    <c:if test="${venue.isPassed.equals('审核通过')}">
        <a href="/venue/${venue.vid}/events" type="button" class="btn btn-info btn-sm">活动管理</a>
        <a href="/venue/${venue.vid}/seats" type="button" class="btn btn-info btn-sm">座位管理</a>
        <a href="/venue/${venue.vid}/books" type="button" class="btn btn-info btn-sm">财务管理</a>
    </c:if>
